...
The function `propop::calculate_emi_rate()` makes it easy to compute `emi_sub`.  
...
(2022–2025) for five regions in the Canton of Aargau. We first use `calculate_emi_rate()` 
...
parameters_rate <- calculate_emi_rate(
...
propop(
  parameters = ag_population_subregional,
  year_first = 2024,
  year_last = 2026,
  age_groups = 101,
  fert_first = 16,
