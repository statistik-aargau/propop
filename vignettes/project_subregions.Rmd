...
`imm_int_n` and `imm_nat_n`. Otherwise `propop()` won't recognize the parameter.  
...
df_hist_imm_int <- tibble::tibble(
  ...
  dplyr::mutate(
    ...
    # occurrences observed in Aargau for international immigration
