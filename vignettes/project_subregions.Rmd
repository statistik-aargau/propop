...
Create data frame with input parameters (the rates and numbers for the 
...
dividing the spatial unit's `n` by the sum of all people in the canton in this
...
df_population_shares |> 
  ...
  DT::formatStyle(c("share"),
                  backgroundColor = DT::styleRow(c(1:5), 
                                                 "#96D4FF", default = "") 
)
```
\ 
