...
group. The main reason for these differences is that FSO uses a different starting 
population, which mainly differs for newborns and old people.
...
just one person across all 404 demographic groups and 31 years. 
