...
illustrate, the example population data in `propop` are currently from 31. December
2023 (update expected for mid-2025) and the first projection year is 2025.
