...
create_mortality_matrix <-
  function(n_age_class,
    ...
    assertthat::assert_that(
      ...
      msg = paste0(
        "Mortality matrix contains NAs within indices: `index_row`,",
        " `index_column`."
      )
    )
    ...
    assertthat::assert_that(
      !is.null(n_age_class),
      msg =
        "Mortality matrix contains NAs within this parameter: `n_age_class`."
    )
    ...
    assertthat::assert_that(
      ...
      msg = "Mortality matrix contains NAs within these vectors: `ch_m_ch_m`,
