...
create_transition_matrix <-
  function(n_age_class,
    ...
    int_m_int_m <-
      (1 - mor_int_m) - (emi_int_m + acq_int_m) * (1 - mor_int_m / 2)

    # Foreign female to foreign female
    int_f_int_f <-
      (1 - mor_int_f) - (emi_int_f + acq_int_f) * (1 - mor_int_f / 2)
