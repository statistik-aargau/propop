...
#' @param emi_int_ch_f numeric, emigration of Swiss females.
#' @param emi_int_ch_m numeric, emigration of Swiss males.
#' @param emi_int_int_f numeric, emigration of foreign females.
#' @param emi_int_int_m numeric, emigration of foreign males.
...
create_transition_matrix <-
  function(n_age_class,
    ...
    ch_m_ch_m <- (1 - mor_ch_m) - emi_int_ch_m * (1 - mor_ch_m / 2)

    # Foreign male to Swiss male
    int_m_ch_m <- acq_int_m * (1 - mor_ch_m / 2)

    # Swiss female to Swiss female
    ch_f_ch_f <- (1 - mor_ch_f) - emi_int_ch_f * (1 - mor_ch_f / 2)
    ...
    int_m_int_m <-
      (1 - mor_int_m) - (emi_int_int_m + acq_int_m) * (1 - mor_int_m / 2)

    # Foreign female to foreign female
    int_f_int_f <-
      (1 - mor_int_f) - (emi_int_int_f + acq_int_f) * (1 - mor_int_f / 2)
