...
```{r comparison-propop-sub, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE, result = FALSE, fig.height = 15}
# Compare results
...
```{r plot-sub, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE, fig.height = 15}
# Plot abs numbers
