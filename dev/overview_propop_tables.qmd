...
```{r eval = FALSE, message = FALSE, warning = FALSE, result = FALSE, echo = TRUE}
...
```{r comparison-propop-sub, echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, result = FALSE, fig.height = 15}
# Compare results
...
```{r plot-sub, echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, fig.height = 15}
# Plot abs numbers
