...
test_that("calculate_rates snapshot - mean, age_group=5, binational, two_sex", {
...
test_that("calculate_rates snapshots should differ - median vs. mean", {
